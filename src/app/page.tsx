    ...
    <PageFrame>
      <div className="">
        ...
        <div className='text-center text-slate-700 pt-4'>
          <div>
            Software Engineer | Web Designer | Multimedia Artist
          </div>
