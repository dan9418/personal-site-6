...
const Row: React.FC<{ imgSrc: StaticImageData, imgAlt: string, text: string, flip?: boolean, linkHref: string, linkText: string }> =
  ({ imgSrc, imgAlt, text, flip, linkHref, linkText }) => {
    const paragraph = (
